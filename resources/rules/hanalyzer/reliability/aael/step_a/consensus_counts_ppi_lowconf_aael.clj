`{:name "consensus-overlap-count-ppi-lowconf-guo-aael"
  ...
  :head ((iaohan/HAN_0000013 iaohan/consensus_overlap_count_aael ?/count)) ;; HAN:low_confidence_ppi_asserted_edge_guo
...
`{:name "asserted-node-interaction-count-ppi-lowconf-guo-aael"
  :description "This rule counts the number of unique node pairings
  that are asserted to 'interact' because they participate in a
  ...
  :head ((iaohan/HAN_0000013 iaohan/asserted_node_interaction_count_aael ?/count)) ;;HAN:low_confidence_ppi_asserted_edge_guo
...
`{:name "consensus-overlap-count-ppi-lowconf-string-aael"
  :description "This rule counts the number of unique node pairings
  that are asserted to 'interact' because they participate in a
  ...
  :head ((iaohan/HAN_0000012 iaohan/consensus_overlap_count_aael ?/count)) ;; HAN:low_confidence_ppi_asserted_edge_string
...
`{:name "asserted-node-interaction-count-ppi-lowconf-string-aael"
  :description "This rule counts the number of unique node pairings
  that are asserted to 'interact' because they participate in a
  ...
  :head ((iaohan/HAN_0000012 iaohan/asserted_node_interaction_count_aael ?/count)) ;; HAN:low_confidence_ppi_asserted_edge_string
